...
const SemproSkripsiMahasiswa = () => {
  ...
  return (
    <div>
      <NavbarDosen />
      <h2 style={styles.title}>Data Jadwal Penguji Sempro</h2>
          ...
          {jadwalPengujiData.map((item, index) => (
            ...
            >
              {Object.entries(item).map(([key, value]) => (
                <div key={key} style={styles.jadwalDetail}>
                  <strong>{key}:</strong>{" "}
                  {typeof value === "object" ? (
      ...
      <br/>
      <br/>
       <h2 style={styles.title}>Data Jadwal Penguji Skripsi</h2>
