...
// const NilaiForm = ({ item, nilaiData, handleNilaiChange, handleSaveNilaiSkripsi, handleSaveNilai }) => {
...
//       // await setDoc(doc(db, "nilaiMahasiswaSkripsi", item.id), updatedNilaiData, { merge: true });
...
//   const [localNilaiData, setLocalNilaiData] = useState(() => {
//     // Ambil data dari localStorage jika ada, jika tidak, gunakan initialData
...
//     return savedImages ? JSON.parse(savedImages) : initialData;
//   });
...
//           const newState = { ...prev, [role]: updatedImages };

//           // Simpan ke localStorage
//           localStorage.setItem("imageData", JSON.stringify(newState));
//           return newState;
//         });
//       };
...
//   useEffect(() => {
//     // Simpan localNilaiData ke localStorage setiap kali berubah
...
const NilaiFormSkripsi = ({ item, handleSaveNilaiSkripsi }) => {
  const [imageFiles, setImageFiles] = useState({
    PEBIMBING: null,
    KETUA_PENGUJI: null,
    ANGGOTA_PENGUJI: null,
