...
import styles from "./navbardosen.module.css"; // Create this CSS file for styling

export default function NavbarDosen({ isLoggedIn }) {
  ...
  return (
    <nav className={styles.navbar}>
      <div className={styles.logo}>
        <Link href="/dashboard-dosen">Dosen</Link> {/* Dashboard link */}
      </div>
      ...
      <ul className={`${styles.menu} ${isOpen ? styles.active : ""}`}>
        <li className={styles.menuItem}>
          <Link href="/dashboard-dosen">Home</Link> {/* Home link */}
        </li>
        <li className={styles.menuItem}>
        ...
        {/* <li className={styles.menuItem}>
          <Link href="/revisidosenpebimbing">Revisi Sempro Mahasiswa</Link>
        </li> */}
        <li className={styles.menuItem}>
          <Link href="/semproskripsimahasiswa">Sempro Skripsi Mahasiswa</Link>
        </li>
        <li className={styles.menuItem}>
